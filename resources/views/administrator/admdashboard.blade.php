...
<div class="d-flex flex-warp divborder divborder-success my-3">
    <div class="flex-fill">
        <h3 class="text-muted">Administrator - Dashboard</h3>
        <h5 class="text-muted">Ringkasan Berdasarkan Kode Status Laporan Pengaduan</h5>
    </div>
</div>
...
<div class="d-flex flex-warp divborder divborder-warning my-3">
    <div class="flex-fill">
        <h3 class="text-muted">Administrator - Dashboard</h3>
        <h5 class="text-muted">Ringkasan Berdasarkan Kode Jenis Laporan Pengaduan</h5>
    </div>
</div>
